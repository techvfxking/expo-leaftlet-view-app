...
import { StyleSheet, SafeAreaView, Alert, View, Text } from 'react-native'
import {
  LatLng,
  LeafletView,
...
export default function App() {
  const [mapCenterPosition, setMapCenterPosition] = React.useState({
    lat: 36.850769,
    lng: -76.285873,
  })
  const [ownPosition, setOwnPosition] = React.useState<any | null>(null)
  const [webViewLeafletRef, setWebViewLeafletRef] = React.useState(null)
